...
<!--Navigation-->
            ...
            <ul>
			  ...
			  <?php 
				...
				$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_type = 'mcms' AND cms_subtype = 'Main Pages' AND cms_count = '0' AND cms_id = '3' ORDER BY cms_id ASC ";
				...
				while($row = mysqli_fetch_object($result)) :
						$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_type = 'mcms' AND cms_subtype='$row->cms_id' ORDER BY cms_id ASC"; 
          ...
          <li >
		   ...
		   <!-- <a <?php if($subnum == 0) {?>href="bps-content.php?cid=<?php echo $row->cms_id;?>"<?php } else { ?> href="#" <?php } if($subnum > 0) : //if submenu exist then make submenus?> rel="submenu<?php echo $row->cms_id;?>"  <?php endif; ?>><?php echo stripslashes($row->cms_title);?></a> -->
            ...
            <a <?php if($subnum == 0){ href="<?php echo $rewritepath; ?>index.php/bps-content/cid/<?php echo $row->cms_id;?>/<?php echo str_replace(" ","-",preg_replace('/\s\s+/', ' ', strtolower(trim(stripslashes($row->cms_title)))))?>/"<?php }} else { ?> href="#" <?php } if($subnum > 0) : //if submenu exist then make submenus?> rel="submenu<?php echo $row->cms_id;?>"  <?php endif; ?>><?php echo stripslashes($row->cms_title);?></a>
            <?php } else { 
					$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_count = '$row->cms_id'";
            ...
            <ul id="submenu<?php echo $row->cms_id;?>" class="ddsubmenustyle blackwhite">
              <?php 
					...
					$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_type = 'mcms'  AND cms_subtype='$subrows->cms_id' ORDER BY cms_id ASC"; 
              ...
              <li>
                ...
                <?php } else { 
					$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_count = '$subrows->cms_id'";
					if(!($activeresult = mysqli_query($connection,$query))) { echo "Query :- " . $query . "<br />Error :- " . mysqli_connect_errno(); exit; }
					$activerow = mysqli_fetch_object($activeresult);
				?>
                ...
                <ul id="submenu<?php echo $subrows->cms_id;?>" class="ddsubmenustyle blackwhite">
                  <?php while($subsubrow = mysqli_fetch_object($subresult2)) : 
						$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_type = 'mcms' AND cms_subtype='$subsubrow->cms_id' ORDER BY cms_id ASC"; 
                  ...
                  <li>
                    ...
                    <?php } else { 
						$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_count = '$subsubrow->cms_id'";
						if(!($activeresult = mysqli_query($connection,$query))) { echo "Query :- " . $query . "<br />Error :- " . mysqli_connect_errno(); exit; }
						$activerow = mysqli_fetch_object($activeresult);
					?>
                    ...
                    <ul id="submenu<?php echo $subsubrow->cms_id;?>" class="ddsubmenustyle blackwhite">
                      ...
                      <li>
                        ...
                        <a href="<?php echo $rewritepath; ?>index.php/bps-content/cid/<?php echo $subsubrows->cms_id;?>/<?php echo str_replace(" ","-",preg_replace('/\s\s+/', ' ', strtolower(trim(stripslashes($subsubrows->cms_title)))))?>/" ><?php echo stripslashes($subsubrows->cms_title);?></a>
                        <?php } else { 
							$query = "SELECT * FROM " . $tblpref . "content_master WHERE cms_count = '$subsubrows->cms_id'";
							if(!($activeresult = mysqli_query($connection,$query))) { echo "Query :- " . $query . "<br />Error :- " . mysqli_connect_errno(); exit; }
							$activerow = mysqli_fetch_object($activeresult);
						?>
...
<div id='cssmenu02'>
<ul> 
	<li><a href="<?php echo $rewritepath; ?>index.php/bps-content/cid/38/speeches">Speeches</a></li>
    <!--<li><a href="fines.html">Fines and Payments</a></li>-->
    <li><a href="<?php echo $rewritepath; ?>index.php/bps-content/cid/67/Cooperate-Social-Responsibility">Cooperate Social Responsibility</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-8">
            ...
            <ul class="socialmedia">
                <li><a href="#" target="_blank"><img src="<?php echo $rewritepath; ?>images/fb.png" alt="facebook"></a></li>
	...
	<div class="col-md-3 col-sm-4 hidden-xs">
    	<div class="searchbox rtpanel">
                ...
                <div class="btn-group srbtn">
                  ...
                  <a class="btn btn-danger" href="<?php echo $rewritepath; ?>index.php/bps-content/cid/31/Community-Policing/">Community <br>Policing</a>
                </div>
          </div>
