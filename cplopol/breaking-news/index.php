...
if($_SESSION[username]=="")
{
	...
	$condition[]="cms_type='breakingnews'";
    ...
    <div class="padtb">
      <form name="frmcms" method="GET" action="index.php">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="40%" align="right">Breaking News Description :</td>
            <td width="60%">
				<select name="txtname" class="inpt" >
					<option value="" >Please Select</option>
					<?php $que2="select * from ".$tblpref."content_master where cms_type='breakingnews'";
		  ...
		  <tr>
            <td width="40%" align="right">Breaking News Date :</td>
            <td width="60%">
...
<?php 
		...
		<td><?=stripslashes($row_country[cms_desc])?></td>
