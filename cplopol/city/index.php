...
$query="select * from ".$tblpref."category WHERE cat_type = 'city' order by cat_id DESC"; 
...
admin_header('../../','City List',$tblpref,$db,$sitepath,$siteurl,$path1,$ckpath,$row_admin);
//admin_nav("../../");
?>
<!--body start -->
<div class="adminbody">
    ...
    <div class="padtb">
      <form name="frmcms" method="GET" action="index.php">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="40%" align="right">City Name: :</td>
            <td width="60%">
...
<div class="box">
    <div class="hdr">
	<h1 class="ico"><img src="icon/icon.png" alt="">City List</h1>
        <div class="addnew">
						<a  href="pub-type-add.php" class="add">Add New</a>
  ...
  <!--   <p align="right"></p> -->
	...
	<?php 
		...
		<tr class="<?=$class?>">
		<td><b><?=$count?></b></td>
		<td><?=stripslashes($row_currency[cat_title])?></td>
		<td class="center">
		<ul class="actions">
			<li><a title="edit" href="pub-type-add.php?mode=edit&pid=<?=$id?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
			<li><a href="submit-pub-type.php?pid=<?=$id?>&mode=del" onclick="if(confirm('Do You Want To Delete This ?')){return true;}else{return false;}"><img src="../../images/delete.png" alt="delete"></a></li>
		</ul></td>
