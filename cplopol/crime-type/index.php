...
//admin_header("../../","Crime Category");
admin_header('../../','Crime Type LIST',$tblpref,$db,$sitepath,$siteurl,$path1,$ckpath,$row_admin);
//admin_nav("../../");
?>
<!--body start -->
<div class="adminbody">
...
<div class="box">
    <div class="hdr">
		<h1 class="ico"><img src="icon/icon.png" alt="">Crime Type LIST</h1>
        <div class="addnew">
