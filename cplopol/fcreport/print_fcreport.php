...
?>
    ...
    <tr>
      <td colspan="2"><p align="left"><b>Feedback & Commendation Report </b></p></td>
    </tr>
    <tr>
	...
	<tr>
      <td align="left" valign="top">Type of report :</td>
      <td align="left"><?=stripslashes($row[fc_report_type])?></td>
    </tr>
	<tr>
      <td colspan="2" valign="top" style="border-bottom:1px dotted #000000;"></td>
    </tr>
	...
	<tr>
      <td align="left" valign="top">Date of Incident :</td>
	...
	<tr>
      <td align="left" valign="top">Time of Incident :</td>
	...
	<tr>
      <td align="left" valign="top">Location of Incident :</td>
	...
	<tr>
      ...
      <td align="left"><table width="100%" cellspacing="0" cellpadding="0">
			<? 
			$queryinit="select * from ".$tblpref."intiat_contact where int_fc_id='$id'"; 
