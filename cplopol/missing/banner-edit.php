...
admin_header('../../','Missing Person',$tblpref,$db,$sitepath,$siteurl,$path1,$ckpath,$row_admin);
...
<div class="frt" style="padding-right:5px;"><a href="bannerlist.php?bnid=3"><img src="../../images/back32.png" alt="Back" title="Back" /></a></div>
<div class="gap"></div>
<?
$nomatch = $_REQUEST[nomatch];
if($nomatch=="exist"){?>
...
<div class="box">
	...
	<div class="rtheading">
        <h1 class="ico"><img src="icon/icon.png" alt="">Missing Person </h1>
    </div>
    </div> 
	 <div class="padtb">
     <form name="frmcmsadd" method="POST" onsubmit="return validateform1();" action="submit-banner.php" enctype="multipart/form-data">
     ...
     <tr>
     <td>
		<input type="text" name="bnname" id="bnname" value="<?php  echo stripslashes($bn_name)?>" class="smlinput">	
	</td>
     </tr>
	  <tr class="even">
	 ...
	 <tr class="even">
		<td> Banner&nbsp;Image :  </br><?php  if($bnid==1){ ?> <span class='warning'>Image width=634 <br/> & height=250 required</span><?php  }if($bnid==2){?><span class='warning'>Image width=120<br/> & height=100 required</span><?php  }if($bnid==3){?><span class='warning'>Image width =207<br/> & height =207 required</span><?php }if($bnid==4){?><span class='warning'>Image width=704<br/> & height=307 required</span><?php }?>   </td>
     </tr>
     <tr>
     <td>
