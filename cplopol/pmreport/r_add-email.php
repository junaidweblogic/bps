...
<div class="box">
    <div class="hdr">
	<? if($rid!=""){?><h1 class="ico-edit">Send Response Of Police Misconduct Report</h1><?}else{?><h1 class="ico-addnew">Add New</h1><?}?>
	<div class="rtheading">
	...
	<div class="padtb">
	 ...
	 { ?>
		<TR>
		<td align="center" ><div class="error">If the reporter did not include the email address the response will not be sent</div>
		</td>
		</tr>
	 <?php
	 } ?>
