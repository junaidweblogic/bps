...
$query="SELECT * FROM ".$tblpref."content_master where  cms_type='property' ";  //Query for search dropdown
...
admin_header('../../','Recovered Property List',$tblpref,$db,$sitepath,$siteurl,$path1,$ckpath,$row_admin);
    ...
    <div class="padtb">
      <form name="frmcms" method="POST" action="index.php">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="60%">
			  <select NAME="cmscat" id="cmscat" onchange="xmlReply();" class="inpt" >
					...
					<?php  
					$query1="select * from ".$tblpref."category WHERE cat_type = 'property'"; 
		  ...
		  <tr>
            <td width="40%" align="right">Recovered Property Name :</td>
            <td width="60%">
			  <div id="corpname">
...
<div class="box">
    <div class="hdr">
		<h1 class="ico"><img src="icon/icon.png" alt="">Recovered Property List</h1>
        <div class="addnew">
  ...
  <!--   <p align="right"></p> -->
	...
	<thead>
	  <tr>
		...
		<th width="35%">Recovered Property Name</th>
		<th width="35%">Recovered Property Category</th>
	...
	<?php 
		...
		<td class="center">
		<ul class="actions">
			<li><a title="edit" href="pub_add.php?mode=edit&puid=<?php  echo $row_country[cms_id]?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
