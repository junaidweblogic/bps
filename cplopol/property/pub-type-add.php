...
<TR>
	...
	<tr><td align="center" class="body">&nbsp;<b><h2>Property Category</h2></b></td></tr>
	<tr><td height="12px"></td></tr>
	<?php  if($flag=="exists"){?>
		<tr>
			<td colspan="8" align="center"><font color="red"> Property Type already exists</font></td>
		</tr>
	<?php  }
	?>
	<tr><td>
            ...
            <TR>
		    <TD align="right" width="30%"> Property Category  :</TD>
