...
$flag = $_REQUEST[flag];
if($flag=="exists"){?>
<p align="center" class="error">Publication Type already exists.</p>
<? } ?>	   
...
<div class="box">
	...
	<div class="rtheading">
        <h1 class="ico"><img src="icon/icon.png" alt="">Publication Category</h1>
    </div>
    </div> 
<div class="padtb">
     ...
     <tr class="even">
		<td> Publication Category<font color="#ff0000">* </font> :     </td>
     </tr>
     <tr>
     <td>
