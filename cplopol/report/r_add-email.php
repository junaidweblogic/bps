...
<div class="box">
	...
	<div class="rtheading">
        <h1 class="ico"><img src="icon/icon.png" alt="">Send Response of Crime Report</h1>
    </div>
    </div> 
	 <div class="padtb">
     ...
     <tr>
     <td>
		<?=stripslashes($row_add[r_reporter])?>
	 </td>
     </tr>
	 <tr class="even">
     ...
     <tr>
     <td>
		<?=stripslashes($row_add[r_details])?>
	 </td>
     </tr>
	 <tr class="even">
		<td> Your Response :     </td>
