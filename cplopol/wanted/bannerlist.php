...
admin_header('../../','Wanted Persons List',$tblpref,$db,$sitepath,$siteurl,$path1,$ckpath,$row_admin);
?>
<!--body start -->
<div class="adminbody">
    ...
    <div class="padtb">
      <form name="frmcms" method="GET" action="index.php">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="40%" align="right">Wanted People Time  :</td>
            <td width="60%">
...
<div class="frt"><a href="index.php"><img src="../../images/back32.png" alt="Back" title="Back"/></a></div>
<div class="gap"></div>
<div class="box">
    <div class="hdr">
		<h1 class="ico"><img src="icon/icon.png" alt="">Wanted Persons List</h1>
        <div class="addnew">
  ...
  <!--   <p align="right"></p> -->
	...
	<thead>
	  <tr>
		...
		<th width="35%">Wanted People Name</th>
		<th width="20%">Wanted People Type</th>
		<th width="20%">Wanted People Image</th>
