...
<main>
    ...
    <section class="innerbg">
    	<div class="container">
            ...
            <h1 class="header">Feedback &amp; Commendation</h1>
            
            <section class="title-section">
                <ol class="breadcrumb">
                  <li><a href="<?php echo $rewritepath;?>index.php/home/">Home</a></li>
                  <li class="active">Feedback &amp; Commendation</li>
                </ol> 
            </section>
...
<!--start-->	
	...
	<h2>Feedback and Commendation</h2>
    ...
    <form action="<?php echo $rewritepath; ?>index.php/submit-feedback-misconduct/" method="POST" name="frmfc" onsubmit="return validate();">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
            <div class="form-group">
                <label>Type of Report :<?php echo preg_chk($_POST['txttype']); ?></label>
                <select class="form-control" name="txttype" id="txttype" required>
                  	<option value="" selected>Please Select</option>
                    <option value="Commendation" <?php if(preg_chk($_POST['txttype']) == 'Commendation'){ ?> selected <?php } ?>>Commendation</option>
                    <option value="Feedback" <?php if(preg_chk($_POST['txttype']) == 'Feedback'){ ?> selected <?php } ?>>Feedback</option>
                </select>
            </div>
        </div>
    ...
    <div class="form-group">
		<input type="hidden" name="categoryfrm" value="FC">
