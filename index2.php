...
include("common/app_function2.php");
//home page content
$sel_home = sprintf("SELECT * FROM ".$tblpref."content_master WHERE cms_id='1' and cms_type='mcms'");
if(!($res_home = mysqli_query($connection,$sel_home))){echo $sel_home.mysqli_errno($connection); exit();}
...
if(!($res_commisioner = mysqli_query($connection,$sel_commisioner))){echo $sel_commisioner.mysqli_errno($connection); exit();}
...
<section>
	<div class="container">
        ...
        <div class="col-md-3">
      	 ...
      	 <marquee  behavior="scroll" direction="up" height="auto" scrollamount="2" onMouseOver="this.setAttribute('scrollamount', 0, 0);" OnMouseOut="this.setAttribute('scrollamount', 2, 0);">
            	
                <ul class="list">
					<?php 

					$query_news = "select * from ".$tblpref."content_master where cms_type='news' and cms_featured='yes' ORDER BY cms_id DESC LIMIT 0,3";
					if(!($result_news = mysqli_query($connection,$query_news))) :
					echo $query_news.mysqli_errno($connection);
					exit();
					endif;
    	...
    	<div class="container">
        	<div class="row flex">
            	<div class="col-md-7 vision">
                	...
                	<?php echo stripslashes($row_commisioner[cms_desc]); ?>
                ...
                <div class="col-md-5 welcomebg">
                        ...
                        <p><a href="<?php echo $rewritepath;?>index.php/bps-content/cid/3/about-us/" class="more">Learn more</a></p>
                </div><!--/welcomebg-->
            </div><!--/-->
        </div>
    </section>
...
<!--tab-->        
      ...
      <div class="tab-content responsive">
		...
		//$query = "SELECT * FROM c_banner WHERE bn_parentid='3' ORDER BY bn_name";
			if (!($result_miss = mysqli_query($connection,$query_miss))){  echo $query_miss.mysqli_errno($connection);  exit(); }
		...
		//$query = "SELECT * FROM c_banner WHERE bn_parentid='3' ORDER BY bn_name";
			if (!($result_wanted = mysqli_query($connection,$query_wanted))){  echo $query_wanted.mysqli_errno($connection);  exit(); }
...
<!--/tab-->	                
                ...
                <div class="btn-group srbtn">
                  ...
                  <a class="btn btn-danger" href="<?php echo $rewritepath; ?>index.php/bps-content/cid/80/crime-statistics/">Crime  <br>Statistics</a>
                </div>
        	...
        	<div class="row">
            	<div class="col-md-8 col-sm-6">
					...
					<?
						...
						if(!($resultevent=mysqli_query($connection,$queryevent))){ echo $queryevent.mysqli_errno($connection);	exit;}
                      ...
                      <div class="list-group bluelist">
						...
						<?php 
							...
							if(!($result_link = mysqli_query($connection,$query_link))) {
								echo $query_link.mysqli_errno($connection);
								exit();
							}
