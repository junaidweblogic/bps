	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6">
			<div class="list-group">
				<a href="#" class="list-group-item active"><strong><?php 
					echo htmlentities(stripslashes($row->cat_title)); ?></strong></a>
					...
					<?php
						...
						if(!($results = mysqli_query($connection,$query))) { echo "Query :- " . $query . "<br />Error :- " . mysqli_connect_errno(); exit; }
					...
					?>
						<a href="#" class="list-group-item"><?php echo htmlentities(stripslashes($rows->cat_title)); ?>
							<ul class="listing">
								<?php
								if($_REQUEST['pstnsrch'] != "") 
								...
								if(!($resultp = mysqli_query($connection,$query))) { echo "Query :- " . $query . "<br />Error :- " . mysqli_connect_errno(); exit; }
