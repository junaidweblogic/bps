 ...
 if($_POST["g-recaptcha-response"]=="")
{
	...
	<body onload="document.frm.submit();">
		<form name="frm" method="POST" action="<?php echo $rewritepath;?>index.php/bps-police-misconduct/">
...
{	
	...
	$msg .= "<br />Date of misconduct - <strong>" . $date1."</strong>";
		$msg .= "<br />Time of misconduct - <strong>" . $time1.":".$mintime.":00".$txttime."</strong>";
		$msg .= "<br />Location of misconduct  - <strong>" . $_POST[location]."</strong>";
	...
	//header("Location:bps-police-misconduct.php?flag=add");
	?>
	   <body onload="document.frm.submit();">
			<form method="POST" action="<?php echo $rewritepath;?>index.php/bps-police-misconduct/" name="frm">
